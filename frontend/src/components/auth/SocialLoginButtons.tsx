    ...
    <div className="space-y-2.5 w-full font-sans">
      <div className="relative my-4">
        <div className="absolute inset-0 flex items-center">
          <div className="w-full border-t border-[#F5E8EE]" />
        </div>
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-white px-3 text-[#886C7B] font-semibold tracking-wider text-[10px]">
            {labelPrefix}
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2.5">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 py-2 px-3 border border-[#F5E8EE] rounded-full bg-[#FFFFFF] hover:bg-[#FFF6F8] hover:border-[#F9B8CA] text-[#1C1217] text-xs font-semibold shadow-xs transition-all disabled:opacity-50 cursor-pointer"
        >
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 py-2 px-3 border border-[#1C1217] rounded-full bg-[#1C1217] hover:bg-[#3D2B35] text-white text-xs font-semibold shadow-xs transition-all disabled:opacity-50 cursor-pointer"
        >
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 py-2 px-3 border border-[#F5E8EE] rounded-full bg-[#FFFFFF] hover:bg-[#FFF6F8] hover:border-[#F9B8CA] text-[#1877F2] text-xs font-semibold shadow-xs transition-all disabled:opacity-50 cursor-pointer"
        >
          ...
          <span className="hidden sm:inline text-xs">Meta</span>
        </button>
      </div>
    </div>
  );
