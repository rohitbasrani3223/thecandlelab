    ...
    <div className="space-y-2.5 w-full font-sans">
      <div className="relative my-4">
        <div className="absolute inset-0 flex items-center">
          <div className="w-full border-t border-[#EADDCB]" />
        </div>
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-white px-3 text-[#7D6F63] font-semibold tracking-wider text-[10px]">
            {labelPrefix}
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2.5">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 py-2 px-3 border border-[#EADDCB] rounded-full bg-[#FFFFFF] hover:bg-[#FAF7F2] hover:border-[#EADDCB] text-[#232323] text-xs font-semibold shadow-xs transition-all disabled:opacity-50 cursor-pointer"
        >
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 py-2 px-3 border border-[#232323] rounded-full bg-[#232323] hover:bg-[#3D2B35] text-white text-xs font-semibold shadow-xs transition-all disabled:opacity-50 cursor-pointer"
        >
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 py-2 px-3 border border-[#EADDCB] rounded-full bg-[#FFFFFF] hover:bg-[#FAF7F2] hover:border-[#EADDCB] text-[#1877F2] text-xs font-semibold shadow-xs transition-all disabled:opacity-50 cursor-pointer"
        >
