    ...
    <div className="w-full bg-[#FAF6F0] min-h-screen font-sans pb-16">
      ...
      <section className="bg-[#3D2B1F] text-[#FAF6F0] py-16 sm:py-24 px-6 sm:px-12 text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto space-y-3 relative z-10">
          <Badge variant="gold" icon={<SparklesIcon size={12} />}>ATELIER LEGAL & COMPLIANCE</Badge>
          <h1 className="text-4xl sm:text-6xl font-serif font-bold text-[#FAF6F0]">
            {titles[type]}
          </h1>
          <p className="text-xs text-[#EFE8DB] font-mono tracking-wider">{dates[type]}</p>
        </div>
      </section>

      {/* Main Legal Content Container */}
      <div className="max-w-4xl mx-auto px-6 sm:px-12 py-12">
        <div className="bg-white border border-[#EFE8DB] rounded-2xl p-8 sm:p-12 shadow-subtle space-y-8 text-[#2C1E16] leading-relaxed text-sm sm:text-base font-light">
          {type === 'privacy' && (
            <>
              <section className="space-y-3">
                <h3 className="font-serif font-bold text-xl text-[#2C1E16]">1. Data Collection & Privacy Commitment</h3>
              ...
              <section className="space-y-3">
                <h3 className="font-serif font-bold text-xl text-[#2C1E16]">2. Payment Processing Security</h3>
                <p className="text-[#7A6B5D]">
              ...
              <section className="space-y-3">
                <h3 className="font-serif font-bold text-xl text-[#2C1E16]">3. Cookies & Analytics</h3>
                <p className="text-[#7A6B5D]">
          ...
          {type === 'terms' && (
            <>
              <section className="space-y-3">
                <h3 className="font-serif font-bold text-xl text-[#2C1E16]">1. Agreement to Terms</h3>
                <p className="text-[#7A6B5D]">
              ...
              <section className="space-y-3">
                <h3 className="font-serif font-bold text-xl text-[#2C1E16]">2. Product Availability & Batch Formulations</h3>
                <p className="text-[#7A6B5D]">
          ...
          {type === 'shipping' && (
            <>
              <section className="space-y-3">
                <h3 className="font-serif font-bold text-xl text-[#2C1E16]">1. Free Shipping Threshold</h3>
                <p className="text-[#7A6B5D]">
              ...
              <section className="space-y-3">
                <h3 className="font-serif font-bold text-xl text-[#2C1E16]">2. Dispatch & Tracking</h3>
                <p className="text-[#7A6B5D]">
          ...
          {type === 'refund' && (
            <>
              <section className="space-y-3">
                <h3 className="font-serif font-bold text-xl text-[#2C1E16]">1. 15-Day Return Guarantee</h3>
                <p className="text-[#7A6B5D]">
                  If you are not completely satisfied with your candle, you may return unopened, unused products in original gold foil packaging within 15 days of delivery for a full refund or exchange.
                </p>
              </section>

              <section className="space-y-3">
                <h3 className="font-serif font-bold text-xl text-[#2C1E16]">2. Damaged in Transit Replacement</h3>
                <p className="text-[#7A6B5D]">
