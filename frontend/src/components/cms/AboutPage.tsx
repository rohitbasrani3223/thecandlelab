...
export const AboutPage: React.FC<AboutPageProps> = ({ onNavigateToShop, onNavigateToContact: _onNavigateToContact }) => {
  return (
    <div className="w-full bg-[#F8F6F0] min-h-screen font-sans">
      {/* 1. Hero Header */}
      <section className="bg-white text-[#232323] py-20 sm:py-28 px-6 sm:px-12 text-center relative overflow-hidden border-b border-[#EADDCB]">
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-12 py-16 sm:py-24 space-y-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-6">
            <span className="text-xs font-bold uppercase tracking-widest text-[#8B6F4E] block">
            ...
            <p className="text-sm text-[#5C5149] font-light leading-relaxed">
          ...
          <div className="lg:col-span-6">
            <div className="relative rounded-3xl overflow-hidden shadow-card border border-[#EADDCB] bg-[#FAF7F2] aspect-4/3">
              <img
        ...
        <div className="space-y-8">
          <div className="text-center max-w-xl mx-auto space-y-2">
            <h3 className="text-2xl sm:text-4xl font-serif font-bold text-[#232323]">
              Our Guiding Principles
            </h3>
            <p className="text-xs sm:text-sm text-[#7D6F63]">
              Uncompromising quality, environmental stewardship, and timeless design.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card variant="bordered" padding="lg" className="bg-white border-[#EADDCB] rounded-3xl space-y-3 shadow-xs">
              <span className="text-3xl">🌿</span>
              <h4 className="font-serif font-bold text-lg text-[#232323]">Sustainable & Toxic-Free</h4>
            ...
            <Card variant="bordered" padding="lg" className="bg-white border-[#EADDCB] rounded-3xl space-y-3 shadow-xs">
              <span className="text-3xl">🪵</span>
              <h4 className="font-serif font-bold text-lg text-[#232323]">FSC Wood Wicks</h4>
              <p className="text-xs text-[#5C5149] font-light leading-relaxed">
            ...
            <Card variant="bordered" padding="lg" className="bg-white border-[#EADDCB] rounded-3xl space-y-3 shadow-xs">
              <span className="text-3xl">✨</span>
              <h4 className="font-serif font-bold text-lg text-[#232323]">Hand-Poured in India</h4>
              <p className="text-xs text-[#5C5149] font-light leading-relaxed">
        ...
        <div className="bg-white rounded-3xl p-8 sm:p-12 border border-[#EADDCB] shadow-card grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div className="space-y-1">
            <div className="text-3xl sm:text-5xl font-serif font-bold text-[#8B6F4E]">50,000+</div>
            <span className="text-xs text-[#7D6F63] uppercase tracking-wider font-semibold">Candles Hand-Poured</span>
          </div>
          <div className="space-y-1">
            <div className="text-3xl sm:text-5xl font-serif font-bold text-[#8B6F4E]">100%</div>
            <span className="text-xs text-[#7D6F63] uppercase tracking-wider font-semibold">Pure Botanical Soy</span>
          </div>
          <div className="space-y-1">
            <div className="text-3xl sm:text-5xl font-serif font-bold text-[#8B6F4E]">4.95 ★</div>
            <span className="text-xs text-[#7D6F63] uppercase tracking-wider font-semibold">Average Rating</span>
          </div>
          <div className="space-y-1">
            <div className="text-3xl sm:text-5xl font-serif font-bold text-[#8B6F4E]">28+</div>
            <span className="text-xs text-[#7D6F63] uppercase tracking-wider font-semibold">Artisan Formulations</span>
          </div>
        </div>
      </section>
    </div>
