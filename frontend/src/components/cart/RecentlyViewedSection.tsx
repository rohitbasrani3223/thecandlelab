    ...
    <div className="space-y-4 pt-8 border-t border-[#EADDCB] font-sans">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {recentItems.map((item) => (
          <Card key={item.id} variant="bordered" padding="md" className="bg-[#FFFFFF] border-[#EADDCB] rounded-2xl space-y-2 shadow-xs">
            <div className="flex items-center justify-between text-xs">
              ...
              <span className="font-bold text-[#232323]">{item.price}</span>
            </div>

            <h5 className="font-serif font-bold text-xs text-[#232323] truncate">{item.name}</h5>
