...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#151515] text-[#F8F5F0] pt-16 pb-8 border-t border-[#383838]">
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        
        {/* Brand Value Pillars */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pb-12 border-b border-[#383838] text-center">
          <div className="flex flex-col items-center space-y-2 p-5 rounded-2xl bg-[#1E1E1E] border border-[#383838]">
            <Leaf className="w-6 h-6 text-[#C8A75A]" />
            <h4 className="text-xs font-serif font-bold uppercase tracking-wider text-[#F8F5F0]">100% Soy & Beeswax</h4>
            <p className="text-[11px] text-[#A8A29E] font-light">Non-toxic, bio-degradable & clean burning</p>
          </div>
          <div className="flex flex-col items-center space-y-2 p-5 rounded-2xl bg-[#1E1E1E] border border-[#383838]">
            <HeartHandshake className="w-6 h-6 text-[#C8A75A]" />
            <h4 className="text-xs font-serif font-bold uppercase tracking-wider text-[#F8F5F0]">Hand-Poured Artisan</h4>
            <p className="text-[11px] text-[#A8A29E] font-light">Crafted in small batches with love</p>
          </div>
          <div className="flex flex-col items-center space-y-2 p-5 rounded-2xl bg-[#1E1E1E] border border-[#383838]">
            <Sparkles className="w-6 h-6 text-[#C8A75A]" />
            <h4 className="text-xs font-serif font-bold uppercase tracking-wider text-[#F8F5F0]">Pure Essential Oils</h4>
            <p className="text-[11px] text-[#A8A29E] font-light">Layered top, middle & base fragrance notes</p>
          </div>
          <div className="flex flex-col items-center space-y-2 p-5 rounded-2xl bg-[#1E1E1E] border border-[#383838]">
            <Truck className="w-6 h-6 text-[#C8A75A]" />
            <h4 className="text-xs font-serif font-bold uppercase tracking-wider text-[#F8F5F0]">Safe Express Shipping</h4>
            <p className="text-[11px] text-[#A8A29E] font-light">Breakage-free insured luxury packaging</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 py-12">
          ...
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-full bg-[#1E1E1E] flex items-center justify-center border border-[#C8A75A]">
                <Flame className="w-4 h-4 text-[#C8A75A]" />
              </div>
              <span className="font-serif text-xl font-bold tracking-tight text-[#F8F5F0]">THE CANDLE LAB</span>
            </div>
            <p className="text-xs text-[#D8D2C8] leading-relaxed max-w-sm font-light">
            ...
            <div className="pt-2">
              ...
              <div className="flex max-w-sm">
                <input
                  ...
                  className="bg-[#1E1E1E] text-xs px-3.5 py-2.5 rounded-l-xl border border-[#383838] w-full focus:outline-none focus:border-[#C8A75A] text-[#F8F5F0] placeholder-[#A8A29E]"
                />
                <button className="bg-[#C8A75A] text-[#151515] px-4 py-2.5 rounded-r-xl text-xs font-bold hover:bg-[#D4B46A] transition-colors flex items-center gap-1">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-[#D8D2C8] font-light">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-[#D8D2C8] font-light">
              ...
              <li className="pt-2 border-t border-[#383838] text-[10px] text-[#A8A29E] flex items-center gap-2">
                <span>Atelier Admin:</span>
                <span className="text-[#C8A75A] hover:underline cursor-pointer">Partner Login</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-[#383838] flex flex-col md:flex-row justify-between items-center text-[11px] text-[#A8A29E] font-light gap-4">
