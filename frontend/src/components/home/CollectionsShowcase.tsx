      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {collections.slice(0, 2).map((col, idx) => {
            const isAlt = idx % 2 === 1;
            const bgClass = isAlt
              ? 'bg-gradient-to-br from-[#232323] via-[#2C1D25] to-[#422D38] border-[#EADDCB]/30'
              : 'bg-gradient-to-br from-[#141312] via-[#232323] to-[#2C1D25] border-[#EADDCB]/20';
            ...
            return (
              ...
              >
                <div className="absolute top-0 right-0 w-72 h-72 bg-[#EADDCB]/15 rounded-full blur-3xl pointer-events-none" />
                ...
                <div className="space-y-4 relative z-10">
                  <span className="bg-[#8B6F4E] text-[#FFFFFF] text-[10px] font-extrabold px-3 py-1 rounded-full uppercase tracking-wider inline-block">
                ...
                <div className="pt-6 relative z-10 flex items-center justify-between border-t border-[#422D38]">
                  <span className="text-xs font-bold text-[#EADDCB]">Curated Selection</span>
                  <Button
                    variant="pink"
                    size="md"
