...
export const HeroBanner: React.FC = () => {
  ...
  return (
    <section className="relative w-full max-w-full bg-[#140D09] border-b border-[#3D2C22] overflow-hidden py-16 sm:py-28 lg:py-32 font-sans text-white">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[400px] sm:max-w-[600px] h-[350px] sm:h-[500px] bg-gradient-to-tr from-[#B88B38]/20 via-[#E6CA65]/10 to-transparent rounded-full blur-3xl pointer-events-none animate-pulse" />
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-9">
          {/* Tagline Badge */}
          <div className="inline-flex max-w-full flex-wrap justify-center items-center gap-1.5 sm:gap-2 bg-[#1C130E]/75 backdrop-blur-md px-3 sm:px-5 py-1.5 sm:py-2 rounded-full border border-[#D4AF37]/40 shadow-[0_0_20px_rgba(212,175,55,0.2)]">
          ...
          <h1 className="text-2xl sm:text-5xl lg:text-7xl font-serif font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#FFFFFF] via-[#FFF5E4] to-[#E5C384] leading-[1.12] sm:leading-[1.08] tracking-tight drop-shadow-[0_4px_24px_rgba(0,0,0,0.9)] break-words">
            {heroTitle}
          </h1>

          {/* Subtitle */}
          <p className="text-xs sm:text-lg text-[#E5D9C5] max-w-2xl mx-auto leading-relaxed font-light drop-shadow-md px-2">
            {heroSubtitle}
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 pt-2 sm:pt-4 w-full max-w-md mx-auto sm:max-w-none">
            <Button
              variant="gold"
              size="lg"
              className="w-full sm:w-auto bg-gradient-to-r from-[#C59B43] via-[#E6CA65] to-[#B88B38] hover:from-[#D4AF37] hover:to-[#C59B43] text-[#1C130E] font-extrabold rounded-full px-6 sm:px-8 py-3.5 sm:py-4 shadow-[0_0_30px_rgba(212,175,55,0.35)] transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer text-sm sm:text-base"
            ...
            <Button
              variant="outline"
              size="lg"
              className="w-full sm:w-auto bg-[#1C130E]/50 backdrop-blur-md border border-[#D4AF37]/60 text-[#F5E6CA] hover:bg-[#D4AF37] hover:text-[#1C130E] hover:border-[#D4AF37] rounded-full px-6 sm:px-8 py-3.5 sm:py-4 transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer shadow-lg text-sm sm:text-base"
          ...
          <div className="pt-6 sm:pt-10 border-t border-white/15 grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 text-center max-w-4xl mx-auto w-full">
            <div className="bg-[#140D09]/70 backdrop-blur-md p-2 sm:p-4 rounded-xl sm:rounded-2xl border border-[#D4AF37]/25 shadow-xl">
              <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-[#D4AF37] block">100% Soy Wax</span>
              <span className="text-[9px] sm:text-[11px] text-[#E5D9C5]/80">Clean & Non-Toxic</span>
            </div>
            <div className="bg-[#140D09]/70 backdrop-blur-md p-2 sm:p-4 rounded-xl sm:rounded-2xl border border-[#D4AF37]/25 shadow-xl">
              <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-[#D4AF37] block">Essential Oils</span>
              <span className="text-[9px] sm:text-[11px] text-[#E5D9C5]/80">IFRA Certified</span>
            </div>
            <div className="bg-[#140D09]/70 backdrop-blur-md p-2 sm:p-4 rounded-xl sm:rounded-2xl border border-[#D4AF37]/25 shadow-xl">
              <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-[#D4AF37] block">Wood Wicks</span>
              <span className="text-[9px] sm:text-[11px] text-[#E5D9C5]/80">Crackling Flame</span>
            </div>
            <div className="bg-[#140D09]/70 backdrop-blur-md p-2 sm:p-4 rounded-xl sm:rounded-2xl border border-[#D4AF37]/25 shadow-xl">
              <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-[#D4AF37] block">Hand-Poured</span>
              <span className="text-[9px] sm:text-[11px] text-[#E5D9C5]/80">Small Batches</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#1F140D] border-t border-[#3D2C22] py-2 px-3 text-center text-[10px] sm:text-xs text-[#E5D9C5] font-semibold tracking-wider flex flex-wrap items-center justify-center gap-2 sm:gap-6 overflow-hidden w-full">
