...
export const ShopHeader: React.FC<ShopHeaderProps> = ({
  ...
  return (
    <section className="py-6 px-6 sm:px-12 font-sans max-w-7xl mx-auto">
      <div className="bg-[#FFFFFF] text-[#232323] rounded-3xl p-8 sm:p-12 shadow-card border border-[#EADDCB] space-y-3 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-80 h-80 bg-[#EADDCB]/15 rounded-full blur-3xl pointer-events-none" />
        <span className="text-[11px] font-bold uppercase tracking-widest text-[#8B6F4E] block relative z-10">
          THE CANDLE LAB CATALOG
        </span>
        <h1 className="text-3xl sm:text-5xl font-serif font-bold text-[#232323] tracking-tight relative z-10">
          {categoryName}
        </h1>
