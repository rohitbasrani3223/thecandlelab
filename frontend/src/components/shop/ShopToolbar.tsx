...
export const ShopToolbar: React.FC<ShopToolbarProps> = ({
  ...
  return (
    <div className="bg-white border border-[#EFE8DB] rounded-2xl p-3 sm:p-4 shadow-subtle flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3 sm:gap-4 font-sans max-w-7xl mx-auto mb-8 w-full max-w-full min-w-0">
        ...
        {CATEGORY_PILLS.map((pill) => {
          ...
          return (
            <button
              ...
              className={`px-3.5 sm:px-4 py-1.5 rounded-full text-xs font-bold transition-all whitespace-nowrap shrink-0 cursor-pointer shadow-xs ${
                isSelected
