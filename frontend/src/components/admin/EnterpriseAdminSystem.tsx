...
import { CategoryManagementModule } from "@/components/modules/CategoryManagementModule";
import { CollectionManagementModule } from "@/components/modules/CollectionManagementModule";
...
import { ReviewsManagementModule } from "@/components/modules/ReviewsManagementModule";
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-[#FAF7F2]">
          ...
          <div className="p-6">
            ...
            {activeModule === "categories"  && <CategoryManagementModule />}
            {activeModule === "collections" && <CollectionManagementModule />}
            {activeModule === "customers"   && <CustomerCRMModule />}
            {activeModule === "coupons"     && <MarketingModule defaultTab="coupons" />}
            {activeModule === "offers"      && <MarketingModule defaultTab="flashsales" />}
            {activeModule === "banners"     && <CMSBuilderModule defaultTab="hero" />}
            {activeModule === "reviews"     && <ReviewsManagementModule />}
            {activeModule === "cms"         && <CMSBuilderModule defaultTab="popup" />}
